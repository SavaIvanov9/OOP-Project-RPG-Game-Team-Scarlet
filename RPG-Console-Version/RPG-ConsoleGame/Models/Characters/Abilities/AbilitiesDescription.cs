...
namespace RPG_ConsoleGame.Models.Characters.Abilities
{
    public static class AbilitiesDescription
    {
        public static string description = "ArcaneBlast = Energy cost: 20, deals character's dmg +50." + Environment.NewLine +
                                    ...
                                    "Slash = Energy cost: 20, deals character's dmg +25." + Environment.NewLine +
                                    "BleedingWounds = Energy cost: 20,  deals character's dmg/2 and dot efect." +
                                    Environment.NewLine +
                                    "Enrage = Energy cost: 10, hp cost: 50, adds dmg x2." + Environment.NewLine +
                                    "Regenerate = Adds +50 energy, +100 hp." + Environment.NewLine +
                                    Environment.NewLine +
            
                                    "Heavyshot = Energy cost: 20, deals character's dmg +100." + Environment.NewLine +
                                    "VenomousArrow = Energy cost: 20, deals character's dmg/2 + dot efect." +
                                    Environment.NewLine +
                                    "Aim = Adds +100 dmg." + Environment.NewLine +
                                    "ActivateCriticalShot = Adds chance to deal dmg x3." + Environment.NewLine +
                                    Environment.NewLine +
            
                                    "Backstab = Energy cost: 40, deals character's dmg x2." + Environment.NewLine +
                                    "SharpenBlades = Energy cost: 20, adds +50 dmg" + Environment.NewLine +
                                    "Execute = Energy cost: 20, deals character's dmg x3 if enemy hp is under 300." +
                                    Environment.NewLine +
                                    "Disable = Reduces enemy dmg" + Environment.NewLine + Environment.NewLine +
            
                                    "Smite = Energy cost: 20, deals character's dmg +50." + Environment.NewLine +
                                    "RighteousStrike = Deals character's dmg/2, heals for character's dmg." +
                                    Environment.NewLine +
                                    "Heal = Energy cost: 30, adds hp equals own dmg *2" + Environment.NewLine +
                                    "DivineShield = Prevents huge amount of dmg for 1 turn." + Environment.NewLine +
                                    Environment.NewLine +
                                    ...
                                    Environment.NewLine +
                                    "ShadowCurse = Deals dot dmg." + Environment.NewLine +
